                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: 10, horizontal: 14.0),
                            child: Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text('Stats',
                            style: TextStyle(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 12),
                        _statRow(Icons.error, '${notifications.where((n) => n['unread']).length} Unread', appGreen),
                        _statRow(Icons.calendar_today, '2 Class Reminders Today', appGreen),
                        _statRow(Icons.check_circle, '${notifications.where((n) => !n['unread']).length} Read in past 7 days', appGreen),
                      ],
                    ),
                  ),
                ],
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () => deleteNotification(originalIndex),
                                  child: const Icon(Icons.delete, color: appRed, size: 18),
                                ),
                              ],
                            ),
                          );
